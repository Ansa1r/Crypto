...
### **Sprint 2: Master Password & Key Management** ✅ (Завершен)
...
```mermaid
flowchart TD
    GUI[GUI Layer<br>PyQt6] --> CORE[Core Layer<br>Business Logic]
    CORE --> CRYPTO[Crypto Layer<br>Argon2, PBKDF2, AES]
    CORE --> DB[Database Layer<br>SQLite]
    CORE --> EVT[Event Bus<br>Decoupled Communication]
    CRYPTO --> KEYCHAIN[Keychain Integration<br>Windows/macOS/Linux]
    CRYPTO --> SECURE_MEM[Secure Memory<br>mlock/VirtualLock]
    EVT --> GUI
```
